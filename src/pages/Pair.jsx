...
const Pair = () => {
    ...
    const handleSearch =async (searchTerm) => {
        try {
            const [parsedChainId, parsedPairAddress] = searchTerm.split('/');
            const res=   await axios.get(`https://api.dexscreener.com/latest/dex/pairs/${parsedChainId}/${parsedPairAddress}`);
